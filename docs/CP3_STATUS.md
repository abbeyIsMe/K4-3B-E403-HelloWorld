...
| Golden set with at least 20 cases | Done on V2 branch | `eval/golden_set_v2.json` contains 30 cases |
| First measurement table with percentage | Done for retrieval layer | `eval/eval_report_v2.md`: 30/30, 100% |
...
1. Run the 30-case set through the real Gemini-backed app with credentials available and record outcome, factuality and citation precision.
